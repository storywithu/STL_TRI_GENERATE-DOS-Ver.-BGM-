...
private :
	...
	int t = 0;
	//int t_1 = 0;
	float xyz_minmax[6] = {0,0,0,0,0,0};
	float* temp_minmax = new float[t_1];


public :
	void calc_area(int index);
	void set_val(int index, float x, float y, float z);
	void set_side(int index);
	void cal_avg_area(int Tri_Num);
	void cal_minmax(int index);
	void cal_count_tri(int Tri_Num);
	void show_count_tri(int Tri_Num);
	//void cal_temp_area(int t);
	void cal_temp_minmax(int index);
	CTri() = default;
	CTri(const CTri&) = delete;
	CTri& operator=(const CTri&) = delete;
	~CTri();
};


void CTri::calc_area(int index)
{
...
void CTri::cal_avg_area(int Tri_Num)
	{
	float sum2 = 0;
...
void CTri::show_count_tri(int Tri_Num)
{
	cout << "Tri_Num" << Tri_Num << endl;
	ofs << "Tri_Num" << "," << Tri_Num << endl;
}

void CTri::cal_minmax(int count2)
{
	float x_min = temp_minmax[0];
	float x_max = temp_minmax[1];
	float y_min = temp_minmax[2];
	float y_max = temp_minmax[3];
	float z_min = temp_minmax[4];
	float z_max = temp_minmax[5];
...
void CTri::cal_temp_minmax(int index)
	{
...
int main()
{
	...
	if (ifs.is_open())
	{
		...
		t1.show_count_tri(count2);
		//t1.cal_temp_area(t);
		t1.cal_avg_area(count2);
		t1.cal_minmax(count2);
